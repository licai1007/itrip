...
<div class="w">
	<div class="breadcrumb">
		<strong><a href="http://channel.jd.com/electronic.html">俄罗斯</a></strong><span>&nbsp;&gt;&nbsp;<a href="http://channel.jd.com/737-794.html" >圣彼得堡</a>&nbsp;&gt;&nbsp;<a href="http://list.jd.com/737-794-798.html" >【2018俄罗斯世界杯主题】圣彼得堡 1小时运河游船之旅（英文导游/语音导览+酒店接送）</a>&nbsp;&nbsp;</span>
	</div>
</div><!--breadcrumb end-->
<div class="w">
...
<ul id="summary">
	...
	<!--freemarker生成的页面，数字默认是带逗号的，加?c去掉逗号-->
...
<script>
	//因为添加到购物车的url无法将商品的数量传递，所以采用js来实现
	function addtocart(){
		var num = $("#buy-num").val();	//获取实际购买的商品数量
		//freemarker生成的页面，数字默认是带逗号的，加?c去掉逗号
		window.location.href="http://localhost:8085/cart/add/${item.id?c}.html?num=" + num;
	}
</script>
</body>
</html>