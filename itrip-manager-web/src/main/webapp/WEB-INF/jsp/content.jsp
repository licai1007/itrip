...
<div class="easyui-panel" title="Nested Panel" data-options="width:'100%',minHeight:500,noheader:true,border:false" style="padding:10px;">
    <div class="easyui-layout" data-options="fit:true">
        ...
        <div data-options="region:'center'" style="padding:5px">
            <table class="easyui-datagrid" id="contentList" data-options="toolbar:contentListToolbar,singleSelect:false,collapsible:true,pagination:true,method:'get',pageSize:10,url:'/content/query/list',queryParams:{categoryid:0}">
		    <thead>
		        <tr>
		            ...
		            <th data-options="field:'url',width:60,align:'center',formatter:itrip.formatUrl">内容连接</th>
		            <th data-options="field:'pic',width:50,align:'center',formatter:itrip.formatUrl">图片</th>
		            <th data-options="field:'pic2',width:50,align:'center',formatter:itrip.formatUrl">图片2</th>
...
var contentListToolbar = [{
    ...
    iconCls:'icon-edit',
    handler:function(){
    	var ids = itrip.getSelectionsIds("#contentList");
    	if(ids.length == 0){
