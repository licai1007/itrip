...
<title>${query} - 搜索 - 爱旅行</title>
<meta name="Keywords" content="java,爱旅行java" />
<meta name="description" content="在爱旅行中找到了29910件java的类似商品，其中包含了“图书”，“电子书”，“教育音像”，“骑行运动”等类型的java的商品。" />
...
<div  id="pagin-btm" class="pagin fr" clstag="search|keycount|search|pre-page2">
	...
	<c:forEach begin="1" end="${totalPages}" var="i">
		<a href="search.html?q=${query}&page=${i}"}>${i}</a>
	</c:forEach>
...
<li class="item-book" bookid="11078102">
	<div class="p-img">
		<a target="_blank" href="http://localhost:8083/item/${item.id }.html">
	...
	<div class="service">由 爱旅行 发货</div>
	<div class="extra">
