...
<div class="w w1 header clearfix">
	<div id="logo"><a href="/"><img clstag="clickcart|keycount|xincart|logo" src="/images/itrip-logo.png" title="返回爱旅行首页" alt="返回爱旅行首页"></a></div>
...
<div class="cart-inner">
    <div class="cart-thead clearfix">
        ...
        <div class="column t-price">爱旅行价</div>
	        ...
	        <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
		        <div class="item_form clearfix">
		            ...
		            <div class="cell p-goods">
		                <div class="p-img">
		                	<a href="http://localhost:8083/item/${cart.id }.html" target="_blank">
              ...
              <div class="cart-button">
                  ...
                  <span class="combine-btns" style="display:none">
                      ...
                      <span class="fore2 hide" style="display: inline;">
                          <a href="javascript:goToOverseaOrder();" class="checkout-jdInt">去爱旅行国际结算<b></b></a>
                          <a href="javascript:goToOrder();" class="checkout-jd">去爱旅行结算<b></b></a>
                      </span>
                  </span>
              </div>
              <div class="total fr">
