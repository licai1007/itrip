    ...
    <script>
    	$(function(){
    		$("#codeBtn").click(function(){
    			...
    			$.ajax({
    				type:"POST",
    				url:"http://localhost:8084/user/sendCode",
    				data:{phone:$('#phone').val()}
    			});
    			var time = 5;
    			var flag = setInterval(function(){ 
    				$("#codeBtn").val("再次发送("+(time--)+"s)"); 
    				//等于0就不再继续往后面执行
    				if(time == -1){
    					clearInterval(flag);
    					$("#codeBtn").val("获取短信验证码"); 
...
<div class="w" id="logo">
    <div>
    	<a href="http://localhost:8081/index">
    		<img src="/images/itrip-logo.png" alt="爱旅行" width="170" height="60"/>
    	</a> <b></b>
    </div>
</div>
        ...
        <form id="personRegForm" method="post" onsubmit="return false;">
            <div class="form" onselectstart="return false;">
                ...
                <div id="o-password">
					...
					<div class="item" id="dpcode">
						<span class="label"><b class="ftx04">*</b>验证码：</span>

						<div class="fl item-ifo">
							<input type="text" id="valiCode" maxlength="4" name="valicode"
								class="text" tabindex="6"
								autocomplete="off" /> <i class="i-phone"></i> <label
								id="valicode_succeed" class="blank"></label> <label
								id="valicode_error"></label>
							<input type="button" id="codeBtn" value="获取短信验证码"/>
						</div>
					</div>
                ...
                <div class="item item-new">
                    ...
                    <div class="fl item-ifo">
                        ...
                        <label for="protocol">我已阅读并同意<a href="#" class="blue" id="protocol">《爱旅行用户注册协议》</a></label>
                        <span class="clr"></span>
