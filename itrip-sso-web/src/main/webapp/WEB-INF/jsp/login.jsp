...
<div class="w">
    <div id="logo">
    	<a href="http://localhost:8082/index.html" clstag="passport|keycount|login|01">
...
<script id="-mob-share" src="http://f1.webshare.mob.com/code/mob-share.js?appkey=26d39d61549e5"></script>
<!--MOB SHARE END-->
</body>
</html>